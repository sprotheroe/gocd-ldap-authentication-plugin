...
import cd.go.authentication.ldap.executors.*;
...
public class LdapPlugin implements GoPlugin {
    ...
    public void getPluginConfigurationFromServer() {
        DefaultGoApiRequest request = new DefaultGoApiRequest(Request.REQUEST_PLUGIN_CONFIGURATION_FROM_SERVER.requestName(), Constants.API_VERSION, Constants.PLUGIN_IDENTIFIER);
