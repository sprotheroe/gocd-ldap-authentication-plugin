...
import cd.go.authentication.ldap.models.Capabilities;
import cd.go.authentication.ldap.models.SupportedAuthType;
...
public class GetCapabilitiesExecutorTest {
    ...
    public void shouldAbleSupportPasswordAndSearchCapabilities() throws Exception {
        ...
        assertThat(capabilities.getSupportedAuthType(), Matchers.is(SupportedAuthType.Password));
